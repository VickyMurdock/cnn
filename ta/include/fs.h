...
#define fopen(...) ofs_stub()
#define fgets(...) ofs_stub()
#define feof(...) ofs_stub()
#define fclose(...) ofs_stub()
#define fopen_s(...) ofs_stub()
#define sprintf(...) ofs_stub()
#define sprintf_s(...) ofs_stub()
