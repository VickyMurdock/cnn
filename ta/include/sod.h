 ...
 */
SOD_APIEXPORT int  sod_cnn_create(sod_cnn **ppOut, const char *zArch, char **buffer, const char **pzErr);
...
SOD_APIEXPORT unsigned char* sod_img_dump_as_png(sod_img input, uint32_t *size);
